...
print(project_path)
PATH_FOR_PROJECT = project_path
sys.path.append(str(PATH_FOR_PROJECT))
...
def main():
    ...
    experiment_params.path = str(project_path / "/results/.models/")
    ...
    with open("predictions_seed_%d.pkl" % seed, "wb") as file:
