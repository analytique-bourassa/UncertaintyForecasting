...
from models.LSTM_Bayesian.data_generation.generate_data import ARData, fixed_ar_coefficients
...
# plot unstable AR data_handling
...
plt.xlabel('t')
plt.ylabel('x_t')
plt.title("Unstable AR data_handling (first 10 dp)")
...
plt.xlabel('t')
plt.ylabel('x_t')
plt.title("Unstable AR data_handling")
...
plt.xlabel('t')
plt.ylabel('x_t')
plt.title("Stable AR data_handling (no noise)")
...
plt.xlabel('t')
plt.ylabel('x_t')
plt.title("Stable AR data_handling (noise var = 1)")
