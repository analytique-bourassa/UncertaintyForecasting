"""
Code to generate autoregressive data_handling.
...
class TimeSeriesData:
    def __init__(self, num_datapoints, test_size=0.2, max_t=20, num_prev=1,
                 noise_var=1):
        """
        Template class for generating time series data_handling.
        :param test_size: in (0,1), data_handling to be used in test set as a fraction of all data_handling generated.
        """
        ...
        # Generate data_handling and reshape data_handling
        self.create_data()
    ...
    def generate_data(self):
        """Generates data_handling in self.y, may take as implicit input timesteps self.t.
        May also generate Bayes predictions."""
        raise NotImplementedError("Generate data_handling method not implemented.")
...
class ARData(TimeSeriesData):
    """Class to generate autoregressive data_handling."""

    def __init__(self, coeffs=None, *args, **kwargs):
...
data_handling = ARData(100, coeffs=fixed_ar_coefficients[5], num_prev=5)
plt.plot(data_handling.y_train)
"""
